...
{
	public class Virtual_App_ApplyJobRecordModel
	{
			...
			public virtual string PK_App_ApplyJob_Id { get; set; }
			...
			public virtual string HappenDate { get; set; }
			public virtual string ConfigDate { get; set; }
			public virtual string ConfigPlace { get; set; }
		}
}
