...
namespace Apps.Models.Sys
{
	public class Virtual_SysMessageModel
	{
			...
			public virtual string BusinessTable { get; set; }
			public virtual string PK_App_Customer_CustomerName { get; set; }
			public virtual string SwitchBtnRead { get; set; }
			public virtual string Title { get; set; }
			public virtual string Content { get; set; }
			public virtual string EnumMessageType { get; set; }
			public virtual string SwitchBtnButton { get; set; }
			public virtual string ShowMessage { get; set; }
