...
{
    public partial class App_RequirementCollectModel
    {
        [Display(Name = "主键")]
    ...
    public override string ToString()    {
        return "PK_App_Requirement_Title:" + PK_App_Requirement_Title + ",PK_App_Customer_CustomerName:" + PK_App_Customer_CustomerName;          }
     }
}
