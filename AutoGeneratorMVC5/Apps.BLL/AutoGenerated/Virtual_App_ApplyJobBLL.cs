...
{
	public class Virtual_App_ApplyJobBLL
	{
        [Dependency]
        public IApp_ApplyJobRepository m_Rep { get; set; }

		public virtual List<App_ApplyJobModel> GetList(ref GridPager pager, string queryStr)
        {

            IQueryable<App_ApplyJob> queryData = null;
            if (!string.IsNullOrWhiteSpace(queryStr))
            {
                queryData = m_Rep.GetList(
								...
								|| a.CurrentStep.Contains(queryStr)
								|| a.EnumApplyStatus.Contains(queryStr)
								
								|| a.EnumPromisePayWay.Contains(queryStr)
        ...
        public virtual List<App_ApplyJobModel> CreateModelList(ref IQueryable<App_ApplyJob> queryData)
        {

            List<App_ApplyJobModel> modelList = (from r in queryData
                                              select new App_ApplyJobModel
                                              {
													Id = r.Id,
													...
													EnumPromisePayWay = r.EnumPromisePayWay,
        ...
        public virtual bool Create(ref ValidationErrors errors, App_ApplyJobModel model)
        {
            try
            {
                App_ApplyJob entity = m_Rep.GetById(model.Id);
                if (entity != null)
                {
                    errors.Add(Resource.PrimaryRepeat);
                    return false;
                }
                entity = new App_ApplyJob();
               				entity.Id = model.Id;
				...
				entity.CurrentStep = model.CurrentStep;
				entity.EnumApplyStatus = model.EnumApplyStatus;
				entity.PromiseMoney = model.PromiseMoney;
				entity.EnumPromisePayWay = model.EnumPromisePayWay;
        ...
        public virtual bool Edit(ref ValidationErrors errors, App_ApplyJobModel model)
        {
            try
            {
                App_ApplyJob entity = m_Rep.GetById(model.Id);
        ...
        public virtual App_ApplyJobModel GetById(string id)
        {
            if (IsExists(id))
            {
                App_ApplyJob entity = m_Rep.GetById(id);
                App_ApplyJobModel model = new App_ApplyJobModel();
                              				model.Id = entity.Id;
				...
				model.CurrentStep = entity.CurrentStep;
				model.EnumApplyStatus = entity.EnumApplyStatus;
				model.PromiseMoney = entity.PromiseMoney;
				model.EnumPromisePayWay = entity.EnumPromisePayWay;
