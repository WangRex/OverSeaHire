...
{
	public class Virtual_App_RequirementCollectBLL
	{
        [Dependency]
        public IApp_RequirementCollectRepository m_Rep { get; set; }

		public virtual List<App_RequirementCollectModel> GetList(ref GridPager pager, string queryStr)
        {

            IQueryable<App_RequirementCollect> queryData = null;
        ...
        public virtual List<App_RequirementCollectModel> CreateModelList(ref IQueryable<App_RequirementCollect> queryData)
        {

            List<App_RequirementCollectModel> modelList = (from r in queryData
                                              select new App_RequirementCollectModel
                                              {
													Id = r.Id,
        ...
        public virtual bool Create(ref ValidationErrors errors, App_RequirementCollectModel model)
        {
            try
            {
                App_RequirementCollect entity = m_Rep.GetById(model.Id);
                if (entity != null)
                {
                    errors.Add(Resource.PrimaryRepeat);
                    return false;
                }
                entity = new App_RequirementCollect();
               				entity.Id = model.Id;
        ...
        public virtual bool Edit(ref ValidationErrors errors, App_RequirementCollectModel model)
        {
            try
            {
                App_RequirementCollect entity = m_Rep.GetById(model.Id);
        ...
        public virtual App_RequirementCollectModel GetById(string id)
        {
            if (IsExists(id))
            {
                App_RequirementCollect entity = m_Rep.GetById(id);
                App_RequirementCollectModel model = new App_RequirementCollectModel();
                              				model.Id = entity.Id;
