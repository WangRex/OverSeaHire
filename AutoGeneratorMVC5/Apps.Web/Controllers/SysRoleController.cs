...
namespace Apps.Web.Controllers
{
    public class SysRoleController : BaseController
    {
        ...
        public JsonResult UpdateUserRoleByRoleId(string roleId, string userIds)
        {
            ...
            if (!string.IsNullOrEmpty(roleId) && !string.IsNullOrEmpty(userIds))
            {
            ...
            {
                string ErrorCol = "用户或者角色信息为空";
                LogHandler.WriteServiceLog(GetUserId(), ErrorCol, "失败", "分配用户", "角色设置");
                return Json(JsonHandler.CreateMessage(0, Resource.SetFail), JsonRequestBehavior.AllowGet);
            }
        ...
        public JsonResult Create(SysRoleModel model)
        {
            ...
            model.CreatePerson = strUserId;
            model.ModificationTime = dtNow;
            model.ModificationPerson = strUserId;
