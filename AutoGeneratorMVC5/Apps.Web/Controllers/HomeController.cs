...
namespace Apps.Web.Controllers
{
    public class HomeController : BaseController
    {
        ...
        public ActionResult Info()
        {
            ...
            //获取城市列表
            var AreaList = areasBLL.GetAllList();
            //防止读取错误
            ...
            SysUserEditModel info = new SysUserEditModel()
            {
                ...
                CityName = areasBLL.GetAreaName(entity.City),
                ProvinceName = areasBLL.GetAreaName(entity.Province),
                VillageName = areasBLL.GetAreaName(entity.Village),
