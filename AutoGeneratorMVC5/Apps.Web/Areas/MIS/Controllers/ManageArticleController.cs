...
// <auto-generated>
//     此代码由T4模板自动生成
//	   生成时间 2017-04-25 15:26:22 by HD
...
namespace Apps.Web.Areas.MIS.Controllers
{
    public class ManageArticleController : BaseController
    {
            ...
            var json = new
            {
                ...
                rows = (from r in list
                        select new MIS_ArticleModel()
                        {
                            ...
                            IsType = enumDictionaryBLL.GetDicName("MIS_Article.IsType", r.IsType)
                        }).ToArray()
            };
            return Json(json);
        }
        ...
        {
            ViewBag.IsType = new SelectList(enumDictionaryBLL.GetDropDownList("MIS_Article.IsType"), "ItemValue", "ItemName");
