...
namespace Apps.Common
{
	...
	public class Thumbnail
	{
        ...
        //生成二维码方法一------------------------------------------------------------------------
        public static string CreateCode_Simple(string nr, string ServerMapPath,string Savepath)
        {
            ...
            image.Dispose();
            //二维码解码
            //string codeDecoder = CodeDecoder(filepath);
            //return codeDecoder;
        ...
        /// <returns></returns>
        public string CreateCode_Choose(string strData, string ServerMapPath,string qrEncoding, string level, int version, int scale)
        {
            QRCodeEncoder qrCodeEncoder = new QRCodeEncoder();
